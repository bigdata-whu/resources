...
[Go to English Version](installHadoop.md)

<https://kontext.tech/column/hadoop/445/install-hadoop-330-on-windows-10-using-wsl>

***********************************

Hadoop 3.3.0 于 2020 年 7 月 14 日发布。这是Apache的第一个
Hadoop 3.3 版本线。与 Hadoop 3.2.0 相比有显著变化，
如 Java 11 运行时支持，protobuf 升级到 3.7.1，
机会型容器调度、HDFS 缓存指令中的非易失性 SCM 支持等。

本文对在 Windows 10 上通过 WSL 安装 Hadoop 3.3.0 进行详细的步骤说明。
这些说明也适用于在 Linux 系统上安装 Hadoop。 
